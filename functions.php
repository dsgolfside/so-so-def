...
function ssd_social_media_nav_menu_icons( $item_output, $item, $depth, $args ) {
    $social_icons = [
        'facebook.com'    => 'M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z',
        'twitter.com'     => 'M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z',
        ...
        'instagram.com'   => 'M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37zM17.5 6.5h.01',
        'linkedin.com'    => 'M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6zM6 9H2v12h4zM4 6a2 2 0 1 0 0-4 2 2 0 0 0 0 4z',
        'youtube.com'     => 'M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33A2.78 2.78 0 0 0 3.4 19c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.25 29 29 0 0 0-.46-5.33zM9.75 15.02V8.48l6.5 3.27-6.5 3.27z',
        'tiktok.com'      => 'M12.53.02C13.84 0 15.14.01 16.44 0c.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-1.07C17.65 8.24 17 7.3 16.22 6.36c-.78-1.01-1.6-1.96-2.3-3.08v8.34c0 2.22 1.81 4.02 4.03 4.02s4.03-1.8 4.03-4.02V8.67h3.36v4.42c0 4.43-3.6 8.03-8.03 8.03-4.43 0-8.03-3.6-8.03-8.03V6.36C7.2 4.16 5.4 2.36 3.18 2.36H0V0h3.18c2.22 0 4.02 1.81 4.02 4.02v8.34C7.2 16.78 5.4 18 3.18 18H0v2.36h3.18c2.33 0 4.31-1.07 5.76-2.84 1.45-1.77 2.3-4.09 2.3-6.54V.02z',
        'soundcloud.com'  => 'M6.7.1C4.3.1 2.2 1.2.7 3.1c-1 1.2-1.1 3.1-.1 4.4 1.4 1.8 4.2 2.3 6.6 1.1 2.1-1.1 3.4-3.5 2.5-5.6C8.8.9 7.9.3 6.7.1zm11 3.4c-1.3 0-2.4 1-2.4 2.3s1.1 2.3 2.4 2.3c1.3 0 2.4-1 2.4-2.3s-1-2.3-2.4-2.3zm-2.4 4.5c-2 0-3.6 1.6-3.6 3.6s1.6 3.6 3.6 3.6c2 0 3.6-1.6 3.6-3.6s-1.6-3.6-3.6-3.6zm-12.2 1c-1.6 0-3 1.3-3 3s1.3 3 3 3c1.6 0 3-1.3 3-3s-1.4-3-3-3zm3.1 4.8c-.1 0-.2.1-.2.2v1.8c0 .1.1.2.2.2h1.6c.1 0 .2-.1.2-.2v-1.8c0-.1-.1-.2-.2-.2h-1.6zm10.7-1.1c-.1 0-.2.1-.2.2v1.8c0 .1.1.2.2.2h1.6c.1 0 .2-.1.2-.2v-1.8c0-.1-.1-.2-.2-.2H17zm3.1-6.7c-.1 0-.2.1-.2.2v8c0 .1.1.2.2.2h1.6c.1 0 .2-.1.2-.2v-8c0-.1-.1-.2-.2-.2h-1.6z',
    ];
