<footer class="site-footer">
  <div class="footer-bar">
    <div class="footer-left">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/images/so-so-def-logo-white.png" alt="So So Def" class="footer-logo">
    </div>
    ...
    <div class="footer-right">
      ...
      <div class="copyright">
        &copy; <?php echo date('Y'); ?> So So Def Recordings
      </div>
    </div>
  </div>
</footer>
